...
public class Humidite2 {

    public static void main(String[] args) throws IOException, InterruptedException {

        Capteur c = new CapteurHumidite("H2", "A", "2");
        ...
        BufferedReader fs = new BufferedReader(new FileReader("D:\\MIOLA\\irrigation-app\\src\\main\\java\\iot\\humidite1.txt"));
